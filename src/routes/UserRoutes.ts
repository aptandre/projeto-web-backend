...
router.get('/get-user-by-email/:email', (req, res) => userController.getUserByEmail(req, res));

// Pegar todos os usuários
router.get('/get-all-users', (req, res) => userController.getAllUsers(req, res));

// Atualizar um usuário
router.get('/update-user/:id', (req, res) => userController.getUserByEmail(req, res));

// Deletar usuário por id
router.delete('/delete-user/:id', (req, res) => userController.deleteUser(req, res));

// Conceder ou remover premium a um usuário
router.put('/premium/:id', (req, res) => userController.toggleUserPremium(req, res));
